...
\begin{enumerate}
    \item \pr{\dfrac{A}{\bar{B}}}\\
    \item \pr{\dfrac{A}{B}}\\
    \item \pr{\dfrac{\bar{A}}{B}}\\
    \item \pr{\dfrac{\bar{A}}{\bar{B}}}\\
\end{enumerate}   
ANSWER:\\
\begin{figure}[h]
...
\end{figure}
 ...
 \begin{align}
      \mathit{S} - B &= \bar{B}\\
    \implies  1 - \pr{B} &= \pr{\bar{B}}\\
    A-AB &= A(1-B) \\
     A-AB &=A\bar{B}\\
    \implies \pr{A}-\pr{AB} &=\pr{A\bar{B}}
\end{align}
...
\end{table}\\
 ...
 Using the above equations (0.0.2) and (0.0.5)
 \begin{align}
